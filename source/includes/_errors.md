...
| <a name="error_17024">17024</a> | Error saving linked document: document cannot be be both a base and dependent document                                                                          | You specified the current document or a document that is already linked to the current one as a link. You cannot link a document to itself directly or through a chain of linked documents, also you cannot specify the same document as both a base and dependent document.    |
