...
| **barcodes**            | Array(Object)                                      | `=` `!=` `~` `~=` `=~`                                                                                                                                | Bundles Barcodes. To filter by a field, you must specify it in the singular **barcode**. [Learn more](../dictionaries/#entities-bundle-bundles-bundle-components-barcodes)                                                       |
