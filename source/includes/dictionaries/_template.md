...
```json
{
   ...
   "meta": {
     "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate",
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/c2645cf0-43f0-3379-adff-99929da86d5e",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/ttn.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/c5d5e3f2-6541-3ae3-9b7c-5da3665ab33e",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "name": "Invoice",
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/rashod.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/8a5bdbc2-ddb6-34f1-b359-05219426b979",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "name": "TORG-12",
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/tov_nakl.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/18386557-0c3d-30bc-9b76-fe30c9893f84",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "name": "sales receipt",
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/demand_check.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/1aaef672-69a5-3e35-a849-71c2cd338ac0",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "name": "Act",
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/act.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/4fdd996f-d2fd-4500-baf2-fea33b6db077",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/upd.xls"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata/embeddedtemplate/4fdd996f-d2fd-4500-baf2-fea33b6db078",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/upd_new.xls"
     }
   ]
}
```
...
```json
{
   ...
   "meta": {
     "href": "https://api.kladana.com/api/remap/1.2/entity/assortment/metadata/embeddedtemplate",
     "type": "embeddedtemplate",
     "mediaType": "application/json",
     "size": 2,
     "limit": 100,
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/assortment/metadata/embeddedtemplate/a8218d14-6017-3ba4-85c4-254fff93bbc8",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "type": "mxtemplate",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/termo_58x40.xml"
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/assortment/metadata/embeddedtemplate/2746190f-cf7c-3a0b-922d-e75f44e88cce",
         "type": "embeddedtemplate",
         "mediaType": "application/json"
       },
       ...
       "type": "mxtemplate",
       "content": "https://api.kladana.com/api/remap/1.2/download-template/price_tag_70x49.5.xml"
     }
   ]
}
```
...
```json
{
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/customerorder/metadata/customtemplate/38d1c843-1601-11e7-8af5-581e00000009",
         "type": "customtemplate",
         "mediaType": "application/json"
       },
       ...
       "name": "tratata",
       "type": "entity",
       "content": "https://api.kladana.com/api/remap/1.2/download/38d1c843-1601-11e7-8af5-581e00000009"
     }
   ]
}
```
...
{
   "meta": {
     "href": "https://api.kladana.com/api/remap/1.2/entity/assortment/metadata/customtemplate/a4d36b88-d329-4b73-966a-b66b6a1b1b9a",
     "type": "customtemplate",
     "mediaType": "application/json"
   },
   ...
   "type": "mxtemplate",
   "content": "https://api.kladana.com/api/remap/1.2/download/a4d36b88-d329-4b73-966a-b66b6a1b1b9a"
}
```
