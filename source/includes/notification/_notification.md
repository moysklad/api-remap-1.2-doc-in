...
```shell
curl -X GET
  "https://app.kladana.in/api/remap/1.2/notification/7944ef04-f831-11e5-7a69-971500188b19"
  -H "Authorization: Basic <Credentials>"
```
...
```json
{
  ...
  "task": {
    "meta": {
      "href": "https://app.kladana.in/api/remap/1.2/entity/task/8413bfc3-56ca-11e9-c0a8-100a00000000",
      "metadataHref": "https://app.kladana.in/api/remap/1.2/entity/task/metadata",
      "type": "task",
      "mediaType": "application/json"
    },
...
```shell
curl -X PUT
  "https://app.kladana.in/api/remap/1.2/notification/7944ef04-f831-11e5-7a69-971500188b19/markasread"
  -H "Authorization: Basic <Credentials>"
```
