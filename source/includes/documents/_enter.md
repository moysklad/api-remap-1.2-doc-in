...
| **files** | MetaArray | | [Files] array metadata(../dictionaries/#suschnosti-fajly) (Maximum number of files - 100)<br>`+Requiredwhen answering ` `+Expand` |
...
| **meta** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | | Stock Adjustment Metadata<br>`+Required when replying` `+Change-handler` |
...
| **overhead** | object | | Overheads. [More here](../dictionaries/#dokumenty-oprihodowanie-oprihodowaniq-nakladnye-rashody). If Stock Adjustment items are not set, then overhead cannot be set<br>`+Update-provider` |
...
| **state** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | `=` `!=` | Stock Adjustment status metadata<br>`+Expand` `+Change-handler` `+Update-provider` |
...
| **overhead** | int | Overheads. [More here](../dictionaries/#dokumenty-oprihodowanie-oprihodowaniq-nakladnye-rashody). If Stock Adjustment items are not set, then no overheads can be set<br>`+Required in response` `+Read-Only` |
...
You can work with items using [special resources for managing Stock Adjustment items](../documents/#dokumenty-oprihodowanie),
...
Learn more about [Stock Adjustment additional fields](../#mojsklad-json-api-obschie-swedeniq-rabota-s-dopolnitel-nymi-polqmi)
...
```shell
curl -X GET
   "https://app.kladana.in/api/remap/1.2/entity/enter"
...
```json
{
   ...
   "meta": {
     "href": "https://app.kladana.in/api/remap/1.2/entity/enter",
   ...
   "rows": [
     ...
     {
       "meta": {
         "href": "https://app.kladana.in/api/remap/1.2/entity/enter/bf19f3fe-4f28-11e6-8a84-bae50000006d",
         "metadataHref": "https://app.kladana.in/api/remap/1.2/entity/enter/metadata",
         "type": "enter",
         "mediaType": "application/json"
       },
...
| Title | Type | Description |
|---------|-------|------- |
| **organization** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Legal entity metadata |
| **store** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Warehouse metadata |
...
```shell
curl -X DELETE
   "https://app.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19"
   -H "Authorization: Basic <Credentials>"
```
...
```shell
curl -X POST
   "https://app.kladana.in/api/remap/1.2/entity/enter/delete"
   -H "Authorization: Basic <Credentials>"
   -H "Content-Type: application/json"
   -d'[
         {
           "meta": {
             "href": "https://app.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b1",
             "metadataHref": "https://app.kladana.in/api/remap/1.2/entity/enter/metadata",
             "type": "enter",
             "mediaType": "application/json"
         },
         {
           "meta": {
             "href": "https://app.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b2",
             "metadataHref": "https://app.kladana.in/api/remap/1.2/entity/enter/metadata",
             "type": "enter",
             "mediaType": "application/json"
         }
...
| **attributes** | Array of additional fields of Stock Adjustment in [metadata](../#mojsklad-json-api-obschie-swedeniq-metadannye) format |
...
```shell
curl -X GET
   "https://app.kladana.in/api/remap/1.2/entity/enter/metadata"
   -H "Authorization: Basic <Credentials>"
```
...
{
   "meta": {
     "href": "https://app.kladana.in/api/remap/1.2/entity/enter/metadata",
     "mediaType": "application/json"
   },
   "attributes": [
     {
...
```shell
curl -X GET
   "https://app.kladana.in/api/remap/1.2/entity/enter/metadata/attributes/7944ef04-f831-11e5-7a69-971500188b19"
   -H "Authorization: Basic <Credentials>"
```
...
```shell
curl -X GET
   "https://app.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions"
   -H "Authorization: Basic <Credentials>"
```
...
what the indicated item is. You can read more about this field in the description [Stock Adjustment items](../documents/#dokumenty-oprihodowanie-oprihodowaniq-pozicii-oprihodowaniq)
...
```shell
curl -X GET
   "https://app.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/7944ef04-f831-11e5-7a69-971500188b20"
   -H "Authorization: Basic <Credentials>"
```
