...
| **quantityMode** | option to filter by value is available. The default value is all. [Available values](../dictionaries1/#11111entities-assortment-assortment-attributes-available-for-filtering-available-values-for-quantitymode) |
