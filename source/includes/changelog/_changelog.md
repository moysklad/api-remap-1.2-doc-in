...
### 23-01-2026
#### Added
- Field `rate` with bank account currency in legal entity accounts, returned in [Legal entity](#/dictionaries/organization#2-yurlico) responses (section "Legal entity accounts").
- Error codes for bank accounts: [80000-80001](..#kladana-json-api-errors-error-codes-for-bank-accounts)
