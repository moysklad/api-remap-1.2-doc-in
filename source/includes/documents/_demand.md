...
| **store**               | [Meta](../#kladana-json-api-general-info-metadata) | `=` `!=`                                                                                                                                           | Warehouse metadata. If the shipment has been completed (applicable = true), warehouse information becomes mandatory. <br>`+Required when replying` `+Expand` `+Change-handler` `+Update-provider` |
...
| **things** | Array(String)                                      | Serial numbers. The value of this attribute is ignored if the item is not in serial accounting. Otherwise, the number of items in the item will be equal to the number of serial numbers passed in the attribute value. If the shipment has been completed (applicable = true), serial numbers become mandatory for items under serial accounting. `+Change-handler` |
...
| Title | Type          | Description |
| ------ |---------------| --------- |
| **cis_1162** | String        | The value of the marking code in the tag format 1162<br>`+Required when replying` `+Read only` |
| **type** | Enum          | Marking code type. Possible values: `trackingcode`, `consumerpack`, `transportpack`<br>`+Required when replying` `+Read only` |
...
```shell
curl --compressed -X GET \
   "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions" \
   -H "Authorization: Basic <Credentials>" \
   -H "Accept-Encoding: gzip"
```
...
```json
{
   ...
   "meta": {
     "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions",
     "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
     "type": "demandposition",
     "mediaType": "application/json",
     "size": 4,
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/40603fbd-019e-11e6-9464-e4de00000086",
         "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
         "type": "demandposition",
         "mediaType": "application/json"
       },
       ...
       "assortment": {
         "meta": {
           ...
           "type": "product",
           "mediaType": "application/json",
           "uuidHref": "https://app.kladana.com/app/#good/edit?id=63b1e1f15-2842-11e9-ac12-000c0000002f"
         }
       }
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/40604612-019e-11e6-9464-e4de00000087",
         "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
         "type": "demandposition",
         "mediaType": "application/json"
       },
       ...
       "assortment": {
         "meta": {
           "href": "https://api.kladana.com/api/remap/1.2/entity/service/60fc3826-00d7-11e6-9464-e4de00000097",
           "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/product/metadata",
           "type": "service",
           "mediaType": "application/json",
           "uuidHref": "https://app.kladana.com/app/#service/edit?id=e64d0a86-2a99-11e9-ac12-000c00000041"
         }
       },
       "cost": 34
     },
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/40604a79-019e-11e6-9464-e4de00000088",
         "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
         "type": "demandposition",
         "mediaType": "application/json"
       },
     ...
     {
       "meta": {
         "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/406055cb-019e-11e6-9464-e4de00000089",
         "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
         "type": "demandposition",
         "mediaType": "application/json"
       },
       ...
       "assortment": {
         "meta": {
           "href": "https://api.kladana.com/api/remap/1.2/entity/product/66cc36dc-f7d2-11e5-8a84-bae500000074",
           "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/variant/metadata",
           "type": "variant",
           "mediaType": "application/json",
...
```json
{
    ...
    "meta": {
       "href":"https://api.kladana.com/api/remap/1.2/entity/demand/8830a022-8a03-11ea-0a80-01cb00000040/positions",
       "type":"demandposition",
       "mediaType":"application/json",
       "size":2,
       "limit":1000,
    ...
    "rows": [
       {
          "meta": {
             "href":"https://api.kladana.com/api/remap/1.2/entity/demand/8830a022-8a03-11ea-0a80-01cb00000040/positions/8830b0fe-8a03-11ea-0a80-01cb00000041",
             "type":"demandposition",
             "mediaType":"application/json"
          },
       ...
       {
          "meta": {
             "href":"https://api.kladana.com/api/remap/1.2/entity/demand/8830a022-8a03-11ea-0a80-01cb00000040/positions/770f45b4-8a04-11ea-0a80-01cb00000060",
             "type":"demandposition",
             "mediaType":"application/json"
          },
          ...
          "assortment": {
             "meta": {
                "href":"https://api.kladana.com/api/remap/1.2/entity/product/b20184da-8493-11ea-0a80-037a00000314",
                "metadataHref":"https://api.kladana.com/api/remap/1.2/entity/product/metadata",
                "type":"product",
                "mediaType":"application/json",
                "uuidHref":"https://app.kladana.com/app/#good/edit?id=b20178fb-8493-11ea-0a80-037a00000312"
             }
          },
          "trackingCodes":[
             {
...
[
   {
     "meta": {
       "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/3bf025cc-0310-11e6-9464-e4de0000000e",
       "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
       "type": "demandposition",
       "mediaType": "application/json"
     },
...
[
   {
     "meta": {
       "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/727cf336-0310-11e6-9464-e4de00000013",
       "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
       "type": "demandposition",
       "mediaType": "application/json"
     },
   ...
   {
     "meta": {
       "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/727cfce0-0310-11e6-9464-e4de00000014",
       "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
       "type": "demandposition",
       "mediaType": "application/json"
     },
   ...
   {
     "meta": {
       "href": "https://api.kladana.com/api/remap/1.2/entity/demand/7944ef04-f831-11e5-7a69-971500188b19/positions/727d057f-0310-11e6-9464-e4de00000015",
       "metadataHref": "https://api.kladana.com/api/remap/1.2/entity/demand/metadata",
       "type": "demandposition",
       "mediaType": "application/json"
     },
     ...
     "assortment": {
       "meta": {
         ...
         "type": "service",
         "mediaType": "application/json",
         "uuidHref": "https://app.kladana.com/app/#service/edit?id=3b1e1f15-2842-11e9-ac12-000c0000002f"
       }
     },
     "pack": {
       "id": "1bf22e62-8b47-11e8-56c0-000800000006",
