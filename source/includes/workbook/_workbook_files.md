...
To add a file via the JSON API, you need to set the `filename` and `content` fields corresponding to the name and content of the file, encoded in Base64, respectively.
