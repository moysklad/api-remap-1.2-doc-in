...
| <a name="error_17024">17024</a> | Error saving linked document: document cannot be linked to itself                                                                                               | You specified the current document or a document that is already linked to the current document as a link. You cannot link a document to itself directly or through a chain of linked documents.    |
...
| <a name="error_26115">26115</a> | Error saving production order: base document and dependent document coincide | Make sure you are not trying to specify the same production order as both the base document (productionTasks field) and the dependent document (productionTaskSupplies field). |
