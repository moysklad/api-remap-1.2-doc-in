...
| **contractType** | Enum | | Contract type. Possible values are listed below in the enum fields table.<br>`+Required when answering` |
...
| ------- | ---------- | ---- | ------- |
| **contractType** | Buy and Sell contract | Sales | Buy and Sell contract |
