...
| <a name="error_1032">1032</a> | Filtering error: feature '{feature name/id}' does not exist | This modification does not have a characteristic with the specified id. Check the correctness of the entered id and the list of characteristics for this modification. |
...
| Error code | Message | Description |
| ------------| ----------| ---------|
| <a name="error_16000">16000</a> | Product preservation error: properties of alcoholic products cannot be negative | Alcoholic fields "code of alcoholic products", "strength" and "volume" must take a value strictly greater than 0. |
| <a name="error_16001">16001</a> | Error saving item: item by weight cannot use serial number accounting | A product cannot be weighted and use accounting by serial numbers at the same time. These are mutually exclusive features. |
...
| <a name="error_16008">16008</a> | Error saving product: to use packages, you need to specify the unit of measure of the product | To use packages, the unit of measure of the product must be specified |
...
| <a name="error_16010">16010</a> | Error saving product: if it is indicated that the product is taxable, then the vat field must be filled in. Otherwise, vatEnabled for the product must be false | When passing the `vatEnabled` = true field, the VAT value must also be specified for the product. |
...
| <a name="error_16012">16012</a> | Error saving goods: goods cannot be draft and weight at the same time. | Goods cannot be both by weight and for bottling. |
...
| <a name="error_16107">16107</a> | Product saving error: TN VED field cannot be specified for: "Tobacco products" | Tobacco products cannot have a TN VED code |
| <a name="error_16108">16108</a> | Error saving goods: TN VED field value not found in the directory | The specified TN VED code does not exist in the EAEU TN VED classifier |
| <a name="error_16109">16109</a> | Error saving goods: TN VED field cannot be specified for non-marked products | The TN VED field can only be present for marked goods |
| <a name="error_16110">16110</a> | Error saving product: <Error text> | There was an error saving the tagged item |
| <a name="error_16111">16111</a> | Error saving goods: the value of the TN VED field does not correspond to the type of marked product | The type of marked products defined by the TN VED does not correspond to the one selected by the user |
| <a name="error_16112">16112</a> | Item Save Error: Label type '<Item Label Type>' does not support partial retirement. | Product label type does not support partial retirement |
| <a name="error_16113">16113</a> | Product save error: The labeled product cannot be used as personal protective equipment. | Labeled goods cannot be personal protective equipment. |
...
| Error code | Message | Description |
| ------------| ----------| ---------|
| <a name="error_26001">26001</a> | Error saving order for production: materials of the order do not match the materials of those. cards | Check the conformity of the materials of the production order and those. cards. |
| <a name="error_26002">26002</a> | Error saving manufacturing order: new items cannot be added to the order | Check your order for new items. |
...
| Error Code | Message| Description|
| ------------| ----------| ---------|
| <a name="error_39000">39000</a> | Error: Required parameter for metric query not specified: {parameter} | Parameters momentFrom, momentTo, interval are required. |
| <a name="error_39001">39001</a> | Bug: Hourly metrics for more than a month are not supported. | Specify a smaller time period. |
| <a name="error_39002">39002</a> | Incorrect value of the filtering parameter 'interval'. Valid values: 'hour', 'day', 'month'. | The value of the 'interval' parameter must be in the list of valid values. |
