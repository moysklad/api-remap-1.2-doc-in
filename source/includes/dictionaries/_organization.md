...
| **companyType** | Enum | `=` `!=` | Legal entity type. Depending on the value of this field, the set of displayed details of the counterparty may change. [More details here](../dictionaries/#entities-entity-jurlica-tip-urlica)<br>`+Required when answering` |
...
| **ChiefAccountSign** | object | | Signature of the chief accountant. [More here](../dictionaries/#entities-entity-legal-entity-attributes-of-entity-address-podpisi-i-pechat) |
| **ChiefAccountant** | String(255) | | Chief accountant |
| **director** | String(255) || Head |
| **directorPosition** | String(255) | | Head position |
| **directorSign** | object | | Leader's signature. [More here](../dictionaries/#entities-entity-legal-entity-attributes-of-entity-address-podpisi-i-pechat) |
...
| **stamp** | object | | Seal. [More here](../dictionaries/#entities-entity-legal-entity-attributes-of-entity-address-podpisi-i-pechat) |
...
marked `Read only` in the description of [legal entity account attributes](../dictionaries/#entities-entity-scheta-urlica).
