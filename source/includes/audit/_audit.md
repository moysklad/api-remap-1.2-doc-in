...
To view the general audit feed via the JSON API, the user can [request a list of contexts](../notification/#audit-audit-get-contexts), which will contain general information
about the changes that have occurred in the system, as well as a link to related events.
To view detailed information on a particular context, you need to [request events for a specific context](../notification/#audit-audit-get-events-by-context).
The response to the user will contain detailed information about the entity changes that occurred as part of this update in the system, in [special diff format](../notification/#audit-audit-events-39-diff-39-field-format)

+ **View events for a single entity**

In order to get events associated with a particular entity, you need to use the [entity event query](../notification/#audit-audit-get-events-by-context).
The response will contain a list of events related to this entity or operation, where the [special diff field](../notification/#audit-audit-events-39-diff-39-field-format) will reflect detailed changes to the fields of the entity or operation.
...
Possible values of the `eventType` and `entityType` parameters are given in the [Filters](../notification/#audit-audit-get-filters) section.
...
| **filter** | `string` (optional) *Example: source=jsonapi* Detailed description of the parameter in the section [Filtering the selection using the filter parameter](../#kladana-json-api-general-info-fil-traciq-wyborki-s-pomosch -u-parametra-filter) Filtering attributes for Audit Contexts are presented in the [Filters](../notification/#audit-audit-filters) section |

> Get Contexts

```shell
curl -X GET
  "https://app.kladana.in/api/remap/1.2/audit"
...
```json
{
  ...
  "meta": {
    "href": "https://app.kladana.in/api/remap/1.2/audit/",
    "type": "audit",
    "mediaType": "application/json",
    "size": 1,
    "limit": 25,
  ...
  "rows": [
    {
      "meta": {
        "href": "https://app.kladana.in/api/remap/1.2/audit/b912e9d1-3fbe-11e7-8a7f-40d000000000",
        "type": "audit",
        "mediaType": "application/json"
      },
...
```json
{
  ...
  "meta": {
    "href": "https://app.kladana.in/api/remap/1.2/audit?filter=entityType=customerorder",
    "type": "audit",
    "mediaType": "application/json",
    "size": 1,
    "limit": 25,
  ...
  "rows": [
    {
      "meta": {
        "href": "https://app.kladana.in/api/remap/1.2/audit/83732f4b-792a-11e7-9464-d04800000005",
        "type": "audit",
        "mediaType": "application/json"
      },
      ...
      "events": {
        "meta": {
          "href": "https://app.kladana.in/api/remap/1.2/audit/83732f4b-792a-11e7-9464-d04800000005/events",
          "type": "auditevent",
          "mediaType": "application/json",
          "size": 1,
          "limit": 25,
...
and consist of information about the time of the event and the changes that occurred during this event. Different types of events differ from each other [diff field format](../notification/#audit-audit-events-39-diff-39-field-format),
...
| **diff** | object | Changes occurred in the Event, in the special diff format described in the [Diff Field Format] section(../notification/#audit-audit-events-39-diff-39-field-format)<br>`+Required for response` `+Only for reading` |
...
Below are the possible formats for the ``diff`` field for different [Event types](../notification/#audit-audit-events-event-types).
...
```shell
curl -X GET
  "https://app.kladana.in/api/remap/1.2/audit/7944ef04-f831-11e5-7a69-971500188b19/events"
  -H "Authorization: Basic <Credentials>"
```
...
```json
{
  ...
  "meta": {
    "href": "https://app.kladana.in/api/remap/1.2/audit/c107864f-3f88-11e7-8a7f-40d000000041/events",
    "type": "auditevent",
    "mediaType": "application/json",
    "size": 1,
    "limit": 25,
  ...
  "rows": [
    {
      ...
      "audit": {
        "meta": {
          "href": "https://app.kladana.in/api/remap/1.2/audit/7944ef04-f831-11e5-7a69-971500188b19",
          "type": "audit",
          "mediaType": "application/json"
        }
      },
      "entity": {
        "meta": {
          "href": "https://app.kladana.in/api/remap/1.2/entity/product/7944ef04-f831-11e5-7a69-971500188b19",
...
```shell
curl -X GET
  "https://app.kladana.in/api/remap/1.2/entity/product/7944ef04-f831-11e5-7a69-971500188b19/audit"
  -H "Authorization: Basic <Credentials>"
```
...
```json
{
  ...
  "meta": {
    "href": "https://app.kladana.in/api/remap/1.2/entity/product/7944ef04-f831-11e5-7a69-971500188b19/audit",
    "type": "auditevent",
    "mediaType": "application/json",
    "size": 1,
    "limit": 25,
...
The JSON API of the MySklad service provides the ability to filter [Audit contexts](../notification/#audit-audit-contexts) using the ``filter`` url parameter.
...
+ **eventType** -
   String type parameter. The [Event type](../notification/#audit-audit-events-event-types) should be passed as a value, according to which
...
```shell
curl -X GET
  "https://app.kladana.in/api/remap/1.2/audit/metadata/filters"
  -H "Authorization: Basic <Credentials>"
```
