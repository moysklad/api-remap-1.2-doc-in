...
```shell
curl -X GET
   "https://api.kladana.in/api/remap/1.2/entity/enter"
...
```json
{
   ...
   "meta": {
     "href": "https://api.kladana.in/api/remap/1.2/entity/enter",
     "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
     "type": "enter",
     "mediaType": "application/json",
     "size": 2,
     "limit": 1000,
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/2e12d827-5338-11e6-8a84-bae50000008e",
         "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
         "type": "enter",
         "mediaType": "application/json"
       },
       ...
       "positions": {
         "meta": {
           "href": "https://api.kladana.in/api/remap/1.2/entity/enter/2e12d827-5338-11e6-8a84-bae50000008e/positions",
           "type": "enterposition",
           "mediaType": "application/json",
           "size": 5,
           "limit": 1000,
     ...
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/bf19f3fe-4f28-11e6-8a84-bae50000006d",
         "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
         "type": "enter",
         "mediaType": "application/json"
       },
       ...
       "positions": {
         "meta": {
           "href": "https://api.kladana.in/api/remap/1.2/entity/enter/bf19f3fe-4f28-11e6-8a84-bae50000006d/positions",
           "type": "enterposition",
           "mediaType": "application/json",
           "size": 1,
           "limit": 1000,
     ...
     -H "Content-Type: application/json"
       -d '{
             ...
             "attributes": [
               {
                 "meta": {
                   "href": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata/attributes/6a9150cd-5338-11e6-8a84-bae50000009b",
               ...
               {
                 "meta": {
                   "href": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata/attributes/6a9158b2-5338-11e6-8a84-bae50000009c",
                   "type": "attributemetadata",
                   "mediaType": "application/json"
                 },
                 "value": 404,
...
{
   "meta": {
     "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7cfff21a-533b-11e6-8a84-bae50000001f",
     "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
     "type": "enter",
     "mediaType": "application/json"
   },
   ...
   "positions": {
     "meta": {
       "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7cfff21a-533b-11e6-8a84-bae50000001f/positions",
       "type": "enterposition",
       "mediaType": "application/json",
       "size": 3,
       "limit": 1000,
...
```shell
curl -X DELETE
   "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19"
   -H "Authorization: Basic <Credentials>"
```
...
```shell
curl -X POST
   "https://api.kladana.in/api/remap/1.2/entity/enter/delete"
   -H "Authorization: Basic <Credentials>"
   -H "Content-Type: application/json"
   -d'[
        {
            "meta": {
                "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b1",
                "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
                "type": "enter",
                "mediaType": "application/json"
            }
        ...
        {
            "meta": {
                "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b2",
                "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
                "type": "enter",
                "mediaType": "application/json"
            }
...
```shell
curl -X GET
   "https://api.kladana.in/api/remap/1.2/entity/enter/metadata"
   -H "Authorization: Basic <Credentials>"
```
...
{
   "meta": {
     "href": "https://api.kladana.in/api/remap/1.2/entity/enter/metadata",
     "mediaType": "application/json"
   },
   "attributes": [
     {
...
```shell
curl -X GET
   "https://api.kladana.in/api/remap/1.2/entity/enter/metadata/attributes/7944ef04-f831-11e5-7a69-971500188b19"
   -H "Authorization: Basic <Credentials>"
```
...
| **meta** | [Meta](../#kladana-json-api-general-info-metadata) | Issuance metadata, |
| **context** | [Meta](../#kladana-json-api-general-info-metadata) | Metadata about the person who made the request. |
| **rows** | Array(Object) | An array of JSON objects representing Stock Adjustment items. |
...
```shell
curl -X GET
   "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions"
   -H "Authorization: Basic <Credentials>"
```
...
```json
{
   ...
   "meta": {
     "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions",
     "type": "enterposition",
     "mediaType": "application/json",
     "size": 5,
     "limit": 1000,
   ...
   "rows": [
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/2e12e9aa-5338-11e6-8a84-bae50000008f",
         "type": "enterposition",
         "mediaType": "application/json"
       },
     ...
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/2e12f062-5338-11e6-8a84-bae500000090",
         "type": "enterposition",
         "mediaType": "application/json"
       },
       ...
       "assortment": {
         "meta": {
           "href": "https://api.kladana.in/api/remap/1.2/entity/product/00de5b31-3303-11e6-8a84-bae500000344",
           "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/product/metadata",
           "type": "product",
           "mediaType": "application/json",
     ...
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/2e12f5d2-5338-11e6-8a84-bae500000091",
         "type": "enterposition",
         "mediaType": "application/json"
       },
       ...
       "assortment": {
         "meta": {
           "href": "https://api.kladana.in/api/remap/1.2/entity/product/0572d2fc-3303-11e6-8a84-bae500000842",
           "metadataHref": "https://api.kladana.in/api/remap/1.2/entity/product/metadata",
           "type": "product",
           "mediaType": "application/json",
     ...
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/2e12fb31-5338-11e6-8a84-bae500000092",
         "type": "enterposition",
         "mediaType": "application/json"
       },
     ...
     {
       "meta": {
         "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/2e1300c8-5338-11e6-8a84-bae500000093",
         "type": "enterposition",
         "mediaType": "application/json"
       },
...
Request to create a new item in Stock Adjustment.
...
what the indicated item is. You can read more about this field in the description [Stock Adjustment items](../documents/#transactions-stock-adjustment-stock-adjustment-stock-adjustment-items)
+ **quantity** - Quantity of the specified item. Must be positive, otherwise an error will occur.
You can create both one and some Stock Adjustment items at the same time. All items created by this request
...
[
   {
     "meta": {
       "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/7ffb0be4-5339-11e6-8a84-bae500000016",
       "type": "enterposition",
       "mediaType": "application/json"
     },
     ...
     "assortment": {
       "meta": {
         ...
         "type": "variant",
         "mediaType": "application/json",
         "uuidHref": "https://app.kladana.in/app/#feature/edit?id=3bad99f1-2842-11e9-ac12-000c0000005c"
       }
     },
     "reason": "Urgent need",
     "overhead": 0
   ...
   {
     "meta": {
       "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/7ffb1271-5339-11e6-8a84-bae500000017",
       "type": "enterposition",
       "mediaType": "application/json"
     },
...
```shell
curl -X GET
   "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/7944ef04-f831-11e5-7a69-971500188b20"
   -H "Authorization: Basic <Credentials>"
```
...
{
   "meta": {
     "href": "https://api.kladana.in/api/remap/1.2/entity/enter/7944ef04-f831-11e5-7a69-971500188b19/positions/7944ef04-f831-11e5-7a69-971500188b20",
     "type": "enterposition",
     "mediaType": "application/json"
   },
