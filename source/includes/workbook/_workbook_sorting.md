...
| <a href="../dictionaries/#entities-assortment">Assortment</a>                | `name`, `code`, `pathName`, `article`                                                                                                                                                             |
...
| <a href="../dictionaries/#entities-product">Product</a>                      | `id`, `version`, `updated`, `updatedBy`, `name`, `code`, `externalCode`, `archived`, `pathName`, `article`, `isSerialTrackable`, `weighed`, `weight`, `volume`, `syncId`                          |
...
| <a href="../dictionaries/#entities-product-variant">Product variant</a>              | `id`,`version`, `updated`,`updatedBy`, `name`, `description`, `code`, `externalCode`, `article`                                                                                           |
