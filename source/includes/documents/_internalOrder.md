...
| **sum** | Float                                             | `=` `!=` `<` `>` `<=` `>=` | Internal Order total amount in paise<br>`+Required when replying` `+Read only` |
...
| Title               | Description                                                                                                                                                  |
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **purchaseOrders**  | An array of links to related Purchase Orders to which this Internal Order is associated in the format [Metadata](../#kladana-json-api-general-info-metadata) |
| **moves**           | An array of links to related Moves which this Internal Order is associated in the format [Metadata](../#kladana-json-api-general-info-metadata)              |
