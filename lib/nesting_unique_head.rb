...
class NestingUniqueHeadCounter < Middleman::Renderers::MiddlemanRedcarpetHTML
  ...
  def postprocess(document)
    document.gsub(
      ...
      '<button class="collapse-button">\1<span><span class="open">Show</span><span class="close">Hide</span><img class="normal" src="/images/expand.svg"><img class="hover" src="/images/expand_hover.svg"></span></button>\3 style=\'display: none;\''
    )
  end
end
