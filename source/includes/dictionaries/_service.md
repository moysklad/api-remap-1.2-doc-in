...
| **barcodes** | Array(Object)                                      | `=` `!=` `~` `~=` `=~` | Service barcodes. To filter by a field, you must specify it in the singular **barcode**. [Learn more](../dictionaries/#entities-service-services-services-metadata-barcodes)                                                                                                                           |
...
| **productFolder** | [Meta](../#kladana-json-api-general-info-metadata) | | group of Service metadata<br>`+Expand`                                                                                                                                                                                           |
