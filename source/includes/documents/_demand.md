...
| **store**               | [Meta](../#kladana-json-api-general-info-metadata) | `=` `!=`                                                                                                                                           | Warehouse metadata. If the shipment is completed (applicable = true) the store becomes mandatory to fill. <br>`+Required when replying` `+Expand` `+Change-handler` `+Update-provider` |
